public class Street_initial {
    public static void main(String[] args){
        ...
        Player.Streets[4] = new Street("Einkommenssteuer", null, 0, 200, "Einkommenssteuer", null, false); //!!rent & price
        ...
        Player.Streets[12] = new Street("Elektrizitätswerk", null, 0, 150, "Werk", null, true); //!rent
        ...
        Player.Streets[28] = new Street("Wasserwerk", null, 0, 150, "Werk", null, true); //!rent
     ...
     //   Player.Streets[31] = new Street("Rathausplatz", new int[]{24, 120, 360, 850, 1025, 1200}, 150, 280, "Street", new int[]{26, 27, 29}, true);
